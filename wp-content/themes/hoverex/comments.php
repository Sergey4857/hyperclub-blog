				...
				$hoverex_comments_args = apply_filters( 'hoverex_filter_comment_form_args', array(
						...
						'fields' => array(
							'author' => hoverex_single_comments_field(array(
												...
												'field_name' => 'author',
												'field_title' => esc_attr__('Name', 'hoverex'),
												'field_placeholder' => esc_attr__( 'Your Name', 'hoverex' )
											)),
							'email' => hoverex_single_comments_field(array(
												...
												'field_name' => 'email',
												'field_title' => esc_attr__('E-mail', 'hoverex'),
												'field_placeholder' => esc_attr__( 'Your E-mail', 'hoverex' )
											))
						),
						...
						'comment_field' => hoverex_single_comments_field(array(
												...
												'field_value' => '',
												'field_name' => 'comment',
												'field_title' => esc_attr__('Comment', 'hoverex'),
												'field_placeholder' => esc_attr__( 'Your comment', 'hoverex' )
											)),
				));
