		...
		<div class="hoverex_options">
			...
			<form id="hoverex_options_form" action="#" method="post" enctype="multipart/form-data">
				...
				<div class="hoverex_options_buttons">
                    <a href="#" class="hoverex_options_button_submit" tabindex="0"><?php esc_html_e( 'Save Options', 'hoverex' ); ?></a>
							...
							. ' value="'
								. (!empty($field['multiple'])
										? (empty($field['data_type']) || $field['data_type']=='image'
											? esc_attr__( 'Add Images', 'hoverex')
											: esc_attr__( 'Add Files', 'hoverex')
											)
										: esc_attr($title)
									)
								. '"'
					...
					$output .= $img && !hoverex_is_inherit($img)
							? '<span>'
									. (in_array(hoverex_get_file_ext($img), array('gif', 'jpg', 'jpeg', 'png'))
											? '<img src="' . esc_url($img) . '" alt="'. esc_attr__('Image', 'hoverex').'">'
		...
		case 'scheme_editor':
			...
			foreach ($value as $scheme=>$v) {
				...
				foreach ($groups as $group_name=>$group_data) {
					$output .= '<span class="hoverex_scheme_editor_header_cell" title="'. esc_attr($group_data['description']).'">' 
				...
				foreach ($colors as $color_name=>$color_data) {
					$output .= '<div class="hoverex_scheme_editor_row">'
								. '<span class="hoverex_scheme_editor_row_cell" title="'. esc_attr($color_data['description']).'">'
