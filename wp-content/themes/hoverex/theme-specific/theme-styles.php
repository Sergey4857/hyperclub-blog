...
table:not(.woocommerce-grouped-product-list)>tbody>tr:first-child>td {
	color: {$colors['text_dark']};
}
...
.wp-block-search:not(.wp-block-search__text-button) .wp-block-search__inside-wrapper:after,
...
/* Normal button */
button:not(.pswp__button):not([aria-controls]),
input[type="reset"],
input[type="submit"],
input[type="button"],
...
.esgbox-container .esgbox-button--arrow_right:hover, .esgbox-container .esgbox-button--arrow_right:focus, 
.esgbox-container .esgbox-button--arrow_left:hover, .esgbox-container .esgbox-button--arrow_left:focus,
.esgbox-container .esgbox-button--close:hover, .esgbox-container .esgbox-button--close:focus {
	background: -moz-linear-gradient(160deg, {$colors['text_link3']} 0%, {$colors['text_link2']} 100%) !important; 
	background: -webkit-gradient(linear, left top, right bottom, color-stop(0%, rgba(1,123,253,1)), color-stop(100%, {$colors['text_link2']})) !important; 
	background: -webkit-linear-gradient(160deg, {$colors['text_link3']} 0%, {$colors['text_link2']} 100%) !important; 
	background: -o-linear-gradient(160deg, {$colors['text_link3']} 0%, {$colors['text_link2']} 100%) !important; 
	background: -ms-linear-gradient(160deg, {$colors['text_link3']} 0%, {$colors['text_link2']} 100%) !important;
	background: linear-gradient(160deg, {$colors['text_link3']} 0%, {$colors['text_link2']} 100%) !important;
	filter: progid:DXImageTransform.Microsoft.gradient( startColorstr={$colors['text_link3']}, endColorstr={$colors['text_link2']},GradientType=1 ) !important; 
}
...
.mejs-controls .mejs-horizontal-volume-slider .mejs-horizontal-volume-total {
	background: {$colors['inverse_link_06']};
}
...
/* Services */
.services_page_tabs.trx_addons_tabs .trx_addons_tabs_titles li:not(.ui-tabs-active){
	background-color: {$colors['input_bg_color']};
}
