...
?><article id="post-<?php the_ID(); ?>" 
	...
	?><div class="post_content entry-content"><?php
		if (hoverex_get_theme_option('blog_content') == 'fullpost') {
			...
			$hoverex_show_learn_more = !in_array($hoverex_post_format, array('link', 'aside', 'status'));
			...
			if ( $hoverex_show_learn_more ) {
				?><p class="sc_button_excerpt"><a class="sc_button sc_button_bordered sc_button_size_small" href="<?php the_permalink(); ?>"><?php esc_html_e('Read more', 'hoverex'); ?></a></p><?php
			}
